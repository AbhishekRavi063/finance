...
import { FaChartBar, FaWallet, FaBalanceScale, FaFileAlt, FaCog, FaSignOutAlt, FaBars } from "react-icons/fa";
...
export default function Sidebar() {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <aside
        className={`w-64 bg-gray-800 p-6 flex flex-col min-h-screen transition-all duration-300
      ...
      <button
        ...
        className="md:hidden p-4 text-white bg-gray-800 hover:bg-gray-700"
      >
        <FaBars />
      </button>
    </div>
